        ...
        builder: (_, __) {
          ...
          return ScreenShell(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              SectionCard(title: 'Find new income', child: const Text('Track current income and add new revenue sources you want the engine to monitor.', style: TextStyle(color: AppColors.textMuted, height: 1.5))),
              const SizedBox(height: 14),
              SectionCard(title: 'Add income source', child: Column(children: [
                TextField(controller: title, decoration: const InputDecoration(labelText: 'Source', prefixIcon: Icon(Icons.work_outline))),
                ...
                const SizedBox(height: 12),
                DropdownButtonFormField<String>(value: category, decoration: const InputDecoration(labelText: 'Category'), items: const [DropdownMenuItem(value: 'Salary', child: Text('Salary')), DropdownMenuItem(value: 'Freelance', child: Text('Freelance')), DropdownMenuItem(value: 'Business', child: Text('Business')), DropdownMenuItem(value: 'Investment', child: Text('Investment')), DropdownMenuItem(value: 'Other', child: Text('Other'))], onChanged: (value) => setState(() => category = value!)),
                const SizedBox(height: 14),
                SizedBox(width: double.infinity, child: FilledButton.icon(onPressed: addIncome, icon: const Icon(Icons.add), label: const Text('Add source'))),
              ])),
              const SizedBox(height: 14),
